<template>
  <div class="app-info">
    <div class="workplace-header">
      <div class="workplace-header-title">工作台</div>
      <div class="workplace-header-content mt-2">
        <div class="workplace-header-content-left">
          <el-image
    ...
    <div class="workplace-content">
      <el-row :gutter="20">
        <el-col :span="16">
          <div class="workplace-content-left">
            <!-- 进行中的任务 -->
            <el-card class="ongoing-task">
              <div slot="header">
                <span>进行中的任务</span>
              ...
              <div class="ongoing-task-list">
                <el-card
                  shadow="hover"
                  v-for="item in ongoingTask"
                  :key="item.id"
                  class="ongoing-task-item"
                >
                  <div class="header">
        ...
        <el-col :span="8">
          <div class="workplace-content-right">
            <!-- 快速开始 / 便捷导航 -->
            <el-card>
              <div slot="header">快速开始 / 便捷导航</div>
              <div class="nav-card">
                <CustomTags
                  :dataList="navTags"
                  @callBack="tagsChange"
            ...
            <!-- 指数 -->
            <el-card class="exponent mt-2">
              <div slot="header">XX 指数</div>
              <div class="radar-chart">
                <RadarMarker></RadarMarker>
              </div>
            </el-card>
            <!-- 团队 -->
            <el-card class="team mt-2">
...
import RadarMarker from "@/components/Charts/RadarMarker";
export default {
  data() {
    return {
      // 进行中的任务
      ongoingTask: [
        ...
        },
        {
          ...
          title: "angular",
          content:
            "是一个应用程序设计框架和开发平台，用于创建高效和复杂的单页应用程序。",
          time: "2小时前",
          owner: "小飞蛾前端组",
        },
        {
      ...
      //   快速开始 / 便捷导航
      navTags: ["标签一", "标签二", "标签三", "标签四", "标签五", "标签六"],
      // 动态列表
      dynamicList: [
        {
          id: 1,
      ...
      teamList: [
        {
          id: 1,
          img: "https://avatars.githubusercontent.com/u/83387408?v=4",
          name: "webdyc",
        },
        {
          id: 2,
          img: "https://avatars.githubusercontent.com/u/10722086?v=4",
          name: "xiusan",
        },
        {
          id: 3,
  ...
  components: { CustomTags, RadarMarker },
  watch: {},
...
.workplace-header {
  ...
  .workplace-header-content {
    ...
    .workplace-header-content-right {
      display: flex;
      .content {
        padding: 0 32px;
        text-align: center;
