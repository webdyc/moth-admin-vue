 ...
 * @date 2022-01-20
 */
public class TbSysRoleOfficeReq implements Serializable
{
    ...
    public TbSysRoleOffice reqToBean() {
        TbSysRoleOffice office = new TbSysRoleOffice();
            office.setId(id);
            office.setRoleId(roleId);
